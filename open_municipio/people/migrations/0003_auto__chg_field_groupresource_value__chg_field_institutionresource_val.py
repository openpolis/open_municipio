...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupResource.value'
        db.alter_column('people_groupresource', 'value', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'InstitutionResource.value'
        db.alter_column('people_institutionresource', 'value', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'PersonResource.value'
        db.alter_column('people_personresource', 'value', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'GroupResource.value'
        db.alter_column('people_groupresource', 'value', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'InstitutionResource.value'
        db.alter_column('people_institutionresource', 'value', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'PersonResource.value'
        db.alter_column('people_personresource', 'value', self.gf('django.db.models.fields.CharField')(max_length=64))
