...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sitting.minute'
        db.add_column(u'people_sitting', 'minute',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sitting_set', null=True, to=orm['acts.Minute']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sitting.minute'
        db.delete_column(u'people_sitting', 'minute_id')
