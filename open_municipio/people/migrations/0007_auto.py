...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field other_institution_set on 'Sitting'
        m2m_table_name = db.shorten_name(u'people_sitting_other_institution_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sitting', models.ForeignKey(orm[u'people.sitting'], null=False)),
            ('institution', models.ForeignKey(orm[u'people.institution'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sitting_id', 'institution_id'])


    def backwards(self, orm):
        # Removing M2M table for field other_institution_set on 'Sitting'
        db.delete_table(db.shorten_name(u'people_sitting_other_institution_set'))
    ...
    models = {
        ...
        u'people.sitting': {
            ...
            'other_institution_set': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'other_institutions'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['people.Institution']"})
        },
