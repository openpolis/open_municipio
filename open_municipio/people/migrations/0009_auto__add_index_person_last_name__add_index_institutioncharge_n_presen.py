...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'people_person', ['last_name'])

        # Adding index on 'InstitutionCharge', fields ['n_present_votations']
        db.create_index(u'people_institution_charge', ['n_present_votations'])

        # Adding index on 'InstitutionCharge', fields ['n_absent_votations']
        db.create_index(u'people_institution_charge', ['n_absent_votations'])

        # Adding index on 'InstitutionCharge', fields ['n_rebel_votations']
        db.create_index(u'people_institution_charge', ['n_rebel_votations'])

        # Adding index on 'InstitutionCharge', fields ['n_present_attendances']
        db.create_index(u'people_institution_charge', ['n_present_attendances'])

        # Adding index on 'InstitutionCharge', fields ['n_absent_attendances']
        db.create_index(u'people_institution_charge', ['n_absent_attendances'])
    ...
    def backwards(self, orm):
        ...
        db.delete_index(u'people_institution_charge', ['n_present_attendances'])
