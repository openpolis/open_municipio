...
from open_municipio.acts.views import ActDetailView, ActListView, ActAddTagsView, ActRemoveTagView, ActEditorView
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<pk>\d+)/tags/edit$', ActEditorView.as_view() , name='om_act_editor'),
