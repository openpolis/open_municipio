...
urlpatterns = patterns('',
    ...
    url(r'^(?P<pk>\d+)/(?P<tab>votes)/$', ActDetailView.as_view(),  name='om_act_detail_votes'),
    # agendas
    ...
    url(r'^agendas/(?P<pk>\d+)/(?P<tab>votes)/$', AgendaDetailView.as_view(),  name='om_agenda_detail_votes'),
    # deliberations
    ...
    url(r'^deliberations/(?P<pk>\d+)/(?P<tab>votes)/$', DeliberationDetailView.as_view(),  name='om_deliberation_detail_votes'),
    # interpellations
    ...
    url(r'^interpellations/(?P<pk>\d+)/(?P<tab>votes)/$', InterpellationDetailView.as_view(),  name='om_interpellation_detail_votes'),
    # interrogations
    ...
    url(r'^interrogations/(?P<pk>\d+)/(?P<tab>votes)/$', InterrogationDetailView.as_view(),  name='om_interrogation_detail_votes'),
    # motions
    ...
    url(r'^motions/(?P<pk>\d+)/(?P<tab>votes)/$', MotionDetailView.as_view(),  name='om_motion_detail_votes'),
 )
