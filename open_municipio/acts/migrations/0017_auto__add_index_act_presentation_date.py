...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Act', fields ['presentation_date']
        db.create_index(u'acts_act', ['presentation_date'])


    def backwards(self, orm):
        # Removing index on 'Act', fields ['presentation_date']
        db.delete_index(u'acts_act', ['presentation_date'])
