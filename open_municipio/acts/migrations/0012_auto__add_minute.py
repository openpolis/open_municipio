...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Minute'
        db.create_table(u'acts_minute', (
            (u'act_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['acts.Act'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'acts', ['Minute'])


    def backwards(self, orm):
        # Deleting model 'Minute'
        db.delete_table(u'acts_minute')
    ...
    models = {
        ...
        u'people.sitting': {
            ...
            'minute': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sitting_set'", 'to': u"orm['acts.Minute']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
