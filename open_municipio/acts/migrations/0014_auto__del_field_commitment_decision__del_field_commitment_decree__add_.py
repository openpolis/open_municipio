...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Commitment.act'
        db.add_column(u'acts_commitment', 'act',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acts.Act'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Commitment.act'
        db.delete_column(u'acts_commitment', 'act_id')
