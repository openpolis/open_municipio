...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('acts_decision', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PRESENTED', max_length=12),
                      keep_default=False)

        # Adding field 'Decree.status'
        db.add_column('acts_decree', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PRESENTED', max_length=12),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('acts_decision', 'status')

        # Deleting field 'Decree.status'
        db.delete_column('acts_decree', 'status')
