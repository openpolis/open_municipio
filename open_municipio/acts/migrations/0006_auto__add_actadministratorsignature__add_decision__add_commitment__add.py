...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActAdministratorSignature'
        db.create_table('acts_actadministratorsignature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('charge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.AdministrationCharge'])),
            ('act', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acts.Act'])),
            ('signature_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('acts', ['ActAdministratorSignature'])

        # Adding model 'Decision'
        db.create_table('acts_decision', (
            ('act_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['acts.Act'], unique=True, primary_key=True)),
            ('total_commitment', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('acts', ['Decision'])

        # Adding M2M table for field commitment_set on 'Decision'
        m2m_table_name = db.shorten_name('acts_decision_commitment_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('decision', models.ForeignKey(orm['acts.decision'], null=False)),
            ('commitment', models.ForeignKey(orm['acts.commitment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['decision_id', 'commitment_id'])

        # Adding model 'Commitment'
        db.create_table('acts_commitment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.AdministrationCharge'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=2)),
            ('selection_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('acts', ['Commitment'])

        # Adding M2M table for field payee_set on 'Commitment'
        m2m_table_name = db.shorten_name('acts_commitment_payee_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('commitment', models.ForeignKey(orm['acts.commitment'], null=False)),
            ('company', models.ForeignKey(orm['people.company'], null=False))
        ))
        db.create_unique(m2m_table_name, ['commitment_id', 'company_id'])

        # Adding model 'Decree'
        db.create_table('acts_decree', (
            ('act_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['acts.Act'], unique=True, primary_key=True)),
            ('total_commitment', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('acts', ['Decree'])

        # Adding M2M table for field commitment_set on 'Decree'
        m2m_table_name = db.shorten_name('acts_decree_commitment_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('decree', models.ForeignKey(orm['acts.decree'], null=False)),
            ('commitment', models.ForeignKey(orm['acts.commitment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['decree_id', 'commitment_id'])

        # Adding field 'Act.emitting_office'
        db.add_column('acts_act', 'emitting_office',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='emitted_act_set', null=True, to=orm['people.Office']),
                      keep_default=False)

        # Adding M2M table for field recipient_administrator_set on 'Act'
        m2m_table_name = db.shorten_name('acts_act_recipient_administrator_set')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('act', models.ForeignKey(orm['acts.act'], null=False)),
            ('administrationcharge', models.ForeignKey(orm['people.administrationcharge'], null=False))
        ))
        db.create_unique(m2m_table_name, ['act_id', 'administrationcharge_id'])


        # Changing field 'Act.emitting_institution'
        db.alter_column('acts_act', 'emitting_institution_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['people.Institution']))

    def backwards(self, orm):
        # Deleting model 'ActAdministratorSignature'
        db.delete_table('acts_actadministratorsignature')

        # Deleting model 'Decision'
        db.delete_table('acts_decision')

        # Removing M2M table for field commitment_set on 'Decision'
        db.delete_table(db.shorten_name('acts_decision_commitment_set'))

        # Deleting model 'Commitment'
        db.delete_table('acts_commitment')

        # Removing M2M table for field payee_set on 'Commitment'
        db.delete_table(db.shorten_name('acts_commitment_payee_set'))

        # Deleting model 'Decree'
        db.delete_table('acts_decree')

        # Removing M2M table for field commitment_set on 'Decree'
        db.delete_table(db.shorten_name('acts_decree_commitment_set'))

        # Deleting field 'Act.emitting_office'
        db.delete_column('acts_act', 'emitting_office_id')

        # Removing M2M table for field recipient_administrator_set on 'Act'
        db.delete_table(db.shorten_name('acts_act_recipient_administrator_set'))


        # Changing field 'Act.emitting_institution'
        db.alter_column('acts_act', 'emitting_institution_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['people.Institution']))
    ...
    models = {
        'acts.act': {
            ...
            'emitting_institution': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'emitted_act_set'", 'null': 'True', 'blank': 'True', 'to': "orm['people.Institution']"}),
            'emitting_office': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'emitted_act_set'", 'null': 'True', 'to': "orm['people.Office']"}),
            ...
            'presenter_administrator_set': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'presented_act_set'", 'to': "orm['people.AdministrationCharge']", 'through': "orm['acts.ActAdministratorSignature']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'recipient_administrator_set': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'received_act_set'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['people.AdministrationCharge']"}),
        ...
        'acts.actadministratorsignature': {
            'Meta': {'object_name': 'ActAdministratorSignature'},
            'act': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['acts.Act']"}),
            'charge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.AdministrationCharge']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'acts.commitment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.AdministrationCharge']"}),
            'payee_set': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['people.Company']", 'null': 'True', 'blank': 'True'}),
            'selection_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'})
        },
        'acts.decision': {
            'Meta': {'object_name': 'Decision', '_ormbases': ['acts.Act']},
            'act_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['acts.Act']", 'unique': 'True', 'primary_key': 'True'}),
            'commitment_set': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['acts.Commitment']", 'null': 'True', 'blank': 'True'}),
            'total_commitment': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2', 'blank': 'True'})
        },
        'acts.decree': {
            'Meta': {'object_name': 'Decree', '_ormbases': ['acts.Act']},
            'act_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['acts.Act']", 'unique': 'True', 'primary_key': 'True'}),
            'commitment_set': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['acts.Commitment']", 'null': 'True', 'blank': 'True'}),
            'total_commitment': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2', 'blank': 'True'})
        },
        ...
        'people.office': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['people.Office']", 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'people.person': {
