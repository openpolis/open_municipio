...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'acts_transition', 'institution',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['people.Institution'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.institution'
        db.delete_column(u'acts_transition', 'institution_id')
