...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transition.attendance'
        db.add_column(u'acts_transition', 'attendance',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attendances.Attendance'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transition.attendance'
        db.delete_column(u'acts_transition', 'attendance_id')
