...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Speech.source_url'
        db.add_column(u'acts_speech', 'source_url',
                      self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Act.source_url'
        db.add_column(u'acts_act', 'source_url',
                      self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speech.source_url'
        db.delete_column(u'acts_speech', 'source_url')

        # Deleting field 'Act.source_url'
        db.delete_column(u'acts_act', 'source_url')
    ...
    models = {
        u'acts.act': {
            ...
            'presentation_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'db_index': 'True'}),
            ...
            'source_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
        ...
        u'acts.audit': {
            'Meta': {'object_name': 'Audit', '_ormbases': [u'acts.Act']},
            u'act_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['acts.Act']", 'unique': 'True', 'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'undefined'", 'max_length': '12'})
        },
        u'acts.calendar': {
        ...
        u'acts.commitment': {
            ...
            'act': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['acts.Act']", 'null': 'True', 'blank': 'True'}),
        ...
        u'acts.minute': {
            'Meta': {'object_name': 'Minute', '_ormbases': [u'acts.Act']},
            u'act_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['acts.Act']", 'unique': 'True', 'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'presented'", 'max_length': '12'})
        },
        u'acts.motion': {
        ...
        u'acts.transition': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['people.Institution']", 'null': 'True'}),
        ...
        u'people.institutioncharge': {
            ...
            'n_absent_attendances': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'n_absent_votations': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'n_present_attendances': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'n_present_votations': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'n_rebel_votations': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        u'people.sitting': {
            ...
            'minute': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sitting_set'", 'null': 'True', 'to': u"orm['acts.Minute']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'other_institution_set': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'other_sittings'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['people.Institution']"})
        },
        ...
        u'votations.chargevote': {
            ...
            'weight': ('django.db.models.fields.DecimalField', [], {'default': '1.0', 'max_digits': '5', 'decimal_places': '2'})
        },
