...
urlpatterns = patterns('',
    ...
    url(r'^terms-and-conditions/$', TemplateView.as_view(template_name='om/privacy.html'), name='om_terms'),
    url(r'^privacy/$', TemplateView.as_view(template_name='om/terms-and-conditions.html'), name='om_privacy'),
