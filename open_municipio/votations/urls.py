...
sqs = SearchQuerySet().\
    ...
    facet('organ').\
    query_facet('votation_date', VotationSearchView.DATE_INTERVALS_RANGES['2017']['qrange']).\
    query_facet('votation_date', VotationSearchView.DATE_INTERVALS_RANGES['2016']['qrange']).\
