...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Votation.source_url'
        db.add_column(u'votations_votation', 'source_url',
                      self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Votation.source_url'
        db.delete_column(u'votations_votation', 'source_url')
