...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Votation.datetime'
        db.add_column(u'votations_votation', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Votation.datetime'
        db.delete_column(u'votations_votation', 'datetime')
