...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChargeVote.weight'
        db.add_column(u'votations_charge_vote', 'weight',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChargeVote.weight'
        db.delete_column(u'votations_charge_vote', 'weight')
