...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'om_atto', 'data_presentazione', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Atto.data_aggiornamento'
        db.add_column(u'om_atto', 'data_aggiornamento', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Atto.data_approvazione'
        db.add_column(u'om_atto', 'data_approvazione', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Atto.data_pubblicazione'
        db.add_column(u'om_atto', 'data_pubblicazione', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Atto.data_esecuzione'
        db.add_column(u'om_atto', 'data_esecuzione', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Atto.data_presentazione'
        db.delete_column(u'om_atto', 'data_presentazione')

        # Deleting field 'Atto.data_aggiornamento'
        db.delete_column(u'om_atto', 'data_aggiornamento')

        # Deleting field 'Atto.data_approvazione'
        db.delete_column(u'om_atto', 'data_approvazione')

        # Deleting field 'Atto.data_pubblicazione'
        db.delete_column(u'om_atto', 'data_pubblicazione')

        # Deleting field 'Atto.data_esecuzione'
        db.delete_column(u'om_atto', 'data_esecuzione')
