...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'om_allegato', 'created_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Atto.created_at'
        db.add_column(u'om_atto', 'created_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Atto.updated_at'
        db.add_column(u'om_atto', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Allegato.created_at'
        db.delete_column(u'om_allegato', 'created_at')

        # Deleting field 'Atto.created_at'
        db.delete_column(u'om_atto', 'created_at')

        # Deleting field 'Atto.updated_at'
        db.delete_column(u'om_atto', 'updated_at')
